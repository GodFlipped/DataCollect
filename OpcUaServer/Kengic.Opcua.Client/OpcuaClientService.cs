...
namespace Kengic.Opcua.Demo.Client
{
    public class OpcuaClientService
    {
        ...
        private string url = "opc.tcp://localhost:8020/KengicOpcua/DemoServer";
        ...
        public void Execte()
        {
            ...
            {
                ApplicationName = "Kengic-Opcua",
                ApplicationUri = Utils.Format(@"urn:{0}:Kengic-Opcua", System.Net.Dns.GetHostName()),
                ApplicationType = ApplicationType.Client,
                SecurityConfiguration = new SecurityConfiguration
                {
                    ApplicationCertificate = new CertificateIdentifier { StoreType = @"Directory", StorePath = Path.Combine(storePath, @"OPC Foundation/CertificateStores/MachineDefault"), SubjectName = Utils.Format(@"CN={0}, DC={1}", "Kengic-Opcua", System.Net.Dns.GetHostName()) },
