...
using KengicCommunication_Core.Serial;
using System;
...
namespace KengicCommunication_Core.Profinet.Melsec
{
    ...
    /// </remarks>
    /// <example>
    /// <code lang="cs" source="KengicCommunication_Core_Net45.Test\Documentation\Samples\Profinet\MelsecFxSerial.cs" region="Usage" title="简单的使用" />
    /// </example>
    public class MelsecFxSerial : SerialDeviceBase<RegularByteTransform>
    {
        ...
        /// <code lang="cs" source="KengicCommunication_Core_Net45.Test\Documentation\Samples\Profinet\MelsecFxSerial.cs" region="ReadExample2" title="Read示例" />
        /// 以下是读取不同类型数据的示例
        /// <code lang="cs" source="KengicCommunication_Core_Net45.Test\Documentation\Samples\Profinet\MelsecFxSerial.cs" region="ReadExample1" title="Read示例" />
        /// </example>
        ...
        /// <returns>带成功标志的结果数据对象</returns>
        /// <example>
        ///  <code lang="cs" source="KengicCommunication_Core_Net45.Test\Documentation\Samples\Profinet\MelsecFxSerial.cs" region="ReadBool" title="Bool类型示例" />
        /// </example>
        ...
        /// <code lang="cs" source="KengicCommunication_Core_Net45.Test\Documentation\Samples\Profinet\MelsecFxSerial.cs" region="WriteExample2" title="Write示例" />
        /// 以下是读取不同类型数据的示例
        /// <code lang="cs" source="KengicCommunication_Core_Net45.Test\Documentation\Samples\Profinet\MelsecFxSerial.cs" region="WriteExample1" title="Write示例" />
        /// </example>
