...
namespace Kengic.Was.CrossCuttings.Netty.Packets
{
    ...
    /// 补码终端状态消息
    /// </summary>
    public class TerminalStatusMessage : NettyClientMessageBody
    {
        public TerminalStatusMessage(IByteBuffer byteBuffer) : base(byteBuffer)
        {
        ...
        public TerminalStatusMessage(ushort msgType, string siteNo, string supplierNo, DateTime dateTime) : base(msgType)
        {
            SiteNo = siteNo;
            MessageLength = 12;
