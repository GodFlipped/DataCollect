...
namespace Kengic.Was.Connector.NettyServer.Packets
{
    ...
    public class SorterResultMessage: NettyClientMessageBody
    {
        ...
        public SorterResultMessage(ushort messageType, ushort scannerType, ushort scannerNo, uint msgSequence, ushort carrierNo,ushort requestDest,ushort  finaltDest,ushort sorterResult, string barcode): base(messageType)
        {
            //确定消息长度，不会有异常
            MessageLength = 33;
