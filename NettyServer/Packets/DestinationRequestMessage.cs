...
namespace Kengic.Was.Connector.NettyServer.Packets
{
    ...
    public class DestinationRequestMessage: NettyClientMessageBody
    {
        ...
        public DestinationRequestMessage(ushort messageType,byte scannerType, byte scannerNo, uint msgSequence, ushort carrierNo, ushort barLength, string barcode, ushort length, ushort wide, ushort height, ushort weight) : base(messageType)
        {
