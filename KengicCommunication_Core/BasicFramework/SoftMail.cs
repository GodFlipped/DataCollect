...
namespace KengicCommunication_Core.BasicFramework
{
    ...
    /// <code lang="cs" source="TestProject\KengicCommunication_CoreDemo\FormMail.cs" region="SoftMail" title="SoftMail示例" />
    /// </example>
    public class SoftMail
    {
        ...
        /// </remarks>
        /// <example>
        /// <code lang="cs" source="KengicCommunication_Core_Net45\BasicFramework\SoftMail.cs" region="Static Mail" title="SoftMail示例" />
        /// </example>
