 ...
 *    功能：  网络通信头，标识消息的内容
 *    
 *    这个类公开在KengicCommunication_Core下面
 * 
 *************************************************************************************/
...
namespace KengicCommunication_Core
{
    ...
    /// <code lang="cs" source="KengicCommunication_Core_Net45.Test\Documentation\Samples\Core\NetHandle.cs" region="NetHandleExample" title="NetHandle示例" />
    /// </example>
