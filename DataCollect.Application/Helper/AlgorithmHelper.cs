...
namespace DataCollect.Application.Helper
{
    ...
    {
        #region 十进制转十六进制
        public static string From10To16(int d)
        {
            string hex = "";
            if (d < 16)
            {
        ...
        public static string BeginChange(int d)
        {
            string hex = "";
            switch (d)
            {
        ...
        /// <returns></returns>
        private static string AddSplitString(Enum16Hex enum16)
        {
            switch (enum16)
            {
                case Enum16Hex.None:
        ...
        /// <returns></returns>
        private static string DeleteSplitString(string inString)
        {
        ...
        /// <returns></returns>
        public static string StringTo16(string inSting, Enum16Hex enum16)
        {
            string outString = "";
        ...
        /// <param name="inSting"></param>
        /// <returns></returns>
        public static byte[] From16ToBtyes(string inSting)
        {
        ...
        /// <returns></returns>
        public static string From16ToString(string inSting)
        {
        ...
        /// <returns></returns>
        public static string BytesToString(byte[] bytes, Enum16Hex enum16)
        {
        ...
        /// <param name="enum16"></param>
        /// <returns></returns>
        public static string BytesTo16(byte[] bytes, Enum16Hex enum16)
        {
            string outString = "";
            for (int i = 0; i < bytes.Length; i++)
            {
        ...
        /// <returns></returns>
        public static string BytesTo2String(byte[] bytes, Enum16Hex enum16)
        {
            string outString = "";
            for (int i = 0; i < bytes.Length; i++)
            {
        ...
        /// <param name="cmdString">命令字符串</param>
        /// <returns></returns>
        public static byte GetBCCXorCodeByByte(byte[] data)
        {
            byte CheckCode = 0;
            int len = data.Length;
            for (int i = 0; i < len; i++)
